#!/home/bespontoff/PycharmProjects/checkio/venv/bin/checkio --domain=py run i-love-python
...
def i_love_python():
    """
        Пайтон экономит моё драгоценное время, которое я могу потратить на себя любимого.
        Пайтон любит меня. Я люблю пайтон. У меня всё.
    """
