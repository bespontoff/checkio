#!/home/bespontoff/PycharmProjects/checkio/venv/bin/checkio --domain=py run bird-language
...
def translate(phrase):
    ...
    while phrase:
        char = phrase[:1]
        res += char
        if char == ' ': phrase = phrase[1:]
        elif char in VOWELS: phrase = phrase[3:]
        else: phrase = phrase[2:]
