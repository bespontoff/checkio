#!/home/bespontoff/PycharmProjects/checkio/venv/bin/checkio --domain=py run popular-words
...
def popular_words(text: str, words: list) -> dict:
    # your code here
    return {key: value for key, value in zip(words, list(map(lambda i: text.lower().split().count(i), words)))}
