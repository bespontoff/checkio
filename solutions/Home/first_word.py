#!/home/bespontoff/PycharmProjects/checkio/venv/bin/checkio --domain=py run first-word
...
def first_word(text: str) -> str:
    ...
    return ''.join([ch for ch in text if ch in string.ascii_letters or ch in ["'", ' ']]).split()[0]
