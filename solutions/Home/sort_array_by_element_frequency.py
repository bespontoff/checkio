#!/home/bespontoff/PycharmProjects/checkio/venv/bin/checkio --domain=py run sort-array-by-element-frequency
...
def frequency_sort(items):
    ...
    counted_items = [(item, items.count(item)) for item in items]
    # sort by frequency
    sorted_items = sorted(counted_items, key=lambda item: item[1], reverse=True)
...
if __name__ == '__main__':
    ...
    assert list(frequency_sort([4, 6, 2, 2, 6, 4, 4, 4])) == [4, 4, 4, 4, 6, 2, 2, 6]
